...
function Analysis2() {
  ...
  const getUsersData = async () => {
    try {
      ...
      const resposne = await axios.get("/api/admin/get-analysis-2", {
        headers: {
  ...
  return (
    <Layout>
      <h1 className="page-header">Analysis-2</h1>
      <hr />
      <p>Top appointment receiving Specializations between years</p>
      <hr/>
      <Form
        layout="vertical"
        onFinish={() => {
